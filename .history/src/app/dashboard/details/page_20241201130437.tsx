      ...
      <div className="notifications-screen">
        ...
        <div className="container mt-2 px-0">
          ...
          <ul className="settings-list-stacked list-group list-group-flush">
            ...
            >
              <p className="mb-0">Expected deposit</p>
              <p className="mb-0 fw-normal">Friday, Dec 8</p>
            </li>
            <li
              className="list-group-item px-4 py-3"
              style={{ cursor: 'pointer' }}
            >
              <p className="mb-0">Expected payout</p>
              <p className="mb-0 fw-normal">Friday, Dec 13</p>
            </li>
          </ul>
        </div>
