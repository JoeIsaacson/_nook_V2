    ...
    switch(params.id) {
      case '1':
        return {
          ...
          time: '4 hours ago',
          content: 'Congratulations! You've earned a referral bonus for bringing a new user to the platform. The bonus has been added to your account.'
        }
      case '2':
        return {
          title: 'Welcome to nook!',
          time: '1 day ago',
          content: 'We're excited to have you join us. Start exploring our platform to discover all the features available to you.'
        }
      default:
        return {
