  ...
  useEffect(() => {
    if (address) {
      ...
      .then(data => {
        ...
        const lendingAssetsRewards = lendingAssets.detail.reward_token_list;
        // console.log('Lending asset supply token info be like', lendingAssetsSupply);
        // console.table(lendingAssetsSupply);
