...
function App() {
  ...
  const setLendingAssetsRewards = () => {
    if (address) {
      ...
      .then(data => {
        ...
        const rewards = lendingPositions.detail.reward_token_list;
        console.log("rewards data:", rewards);
        console.log("rewards amount:", rewards[0].amount);
        return rewards;
      })
  ...
  const lendingAssetsRewards = setLendingAssetsRewards();
