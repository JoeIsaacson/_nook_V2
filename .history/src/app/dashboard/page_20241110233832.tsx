    ...
    <div className="container">
      <div className="row">
        <div className="left-panel col-6 d-none d-lg-block d-flex align-items-center justify-content-center">
          <p className="d-flex align-items-center justify-content-center h-100 display-1 fs-4 text-decoration-underline text-center">NOOK</p>
          <p className="d-flex align-items-center justify-content-center h-100 text-center">Hi, it's me</p>
        </div>
